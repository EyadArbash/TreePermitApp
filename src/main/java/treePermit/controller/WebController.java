...
public class WebController {
	...
	public String dashboardClerks(Model model) {
		try {
			...
			// Füge die Anträge dem Model hinzu, damit sie in der Ansicht verwendet werden
			// können
			...
			e.printStackTrace(); // Dies gibt den Fehler auf der Konsole aus, um eine bessere Diagnose zu
									// ermöglichen
	...
	public ModelAndView submitApplication(@RequestParam("vorname") String vorname,
			...
			@RequestParam("stadt") String stadt, @RequestParam("plz") String plz) {
